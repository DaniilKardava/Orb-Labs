...
async def EIP_1997(w3, proxy):
    """
    Asynchronously request the implementation contract through the standard memory address used in EIP-1997
    ...
    Returns:
    (Coroutine -> string) Coroutine resolving to the implementation contract address (if exists, else 0x0)
    """
...
async def OpenZeppelin(w3, proxy):
    """
    Asynchronously request the implementation contract through the standard memory address used pre EIP-1997
